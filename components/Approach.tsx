...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-green/[0.2] group/canvas-card flex items-center justify-center dark:border-green/[0.2]  max-w-sm w-full mx-auto p-4 relative lg:h-[35rem] rounded-3xl"
    >
      <Icon className="absolute h-6 w-6 -top-3 -left-3 dark:text-green-500 text-black" />
      <Icon className="absolute h-6 w-6 -bottom-3 -left-3 dark:text-green-500 text-black" />
      <Icon className="absolute h-6 w-6 -top-3 -right-3 dark:text-green-500 text-black" />
      <Icon className="absolute h-6 w-6 -bottom-3 -right-3 dark:text-green-500 text-black" />
      ...
      <div className="relative z-20">
        ...
        <h2 className="text-sm dark:text-white opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition text-center duration-200" style={{color: '#e4ecff'}}>
          {description}
        </h2>
      </div>
    </div>
